...
LABEL@0000000000A65780:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002D8DC98

    ;"Goto" previous ident "ed2"(as label)
    jmp LABEL@0000000000A60748

    ;null statement (non-context)

    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002D8DC98:
    ...
    jmp LABEL@0000000000A65780

    ;null statement (non-context)

    ;ident "ed2"(as label) previous ":"
LABEL@0000000000A60748:
...
LABEL@0000000000A719B0:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002D9B090

    ;"Goto" previous ident "ed0"(as label)
    jmp LABEL@0000000000A71A30

    ;null statement (non-context)

    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002D9B090:
...
LABEL@0000000000A71AB0:
    ...
    ;after cond expresion (after "If")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002DA0C00

    ;"Goto" previous ident "ed1"(as label)
    jmp LABEL@0000000000A83A28

    ;null statement (non-context)

    ;";" (after "then"-part of If-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002DA0C00:
    ...
    jmp LABEL@0000000000A71AB0

    ;null statement (non-context)

    ;ident "ed1"(as label) previous ":"
LABEL@0000000000A83A28:
    ...
    jmp LABEL@0000000000A719B0

    ;null statement (non-context)

    ;ident "ed0"(as label) previous ":"
LABEL@0000000000A71A30:
